...
letan.tip=function(txt){							//信息提示
	 ...
	 if($(".letantips").length > 0){
		...
		var tipsObj = $('<div style="z-index:999999; position:fixed;top:35%; width:100%;" class="letantips"><p style="text-align:center;width:280px; margin:0 auto; padding:10px 12px 10px; color:#f56c6c; text-align:center; font-size:14px; margin:0 auto; background:#fef0f0; border-radius:5px; line-height:18px;">'+ txt + '</p></div>');
		$("body").append(tipsObj);
		setTimeout(function(){
 ...
 letan.tipreload=function(txt){			//提示后刷新
	 ...
	 if($(".letantips").length > 0){
		...
		var tipsObj = $('<div style="z-index:999999; position:fixed;top:25%; width:100%;" class="letantips"><p style="text-align:center;width:280px; margin:0 auto; padding:10px 12px 10px; color:#f56c6c; text-align:center; font-size:14px; margin:0 auto; background:#fef0f0; border-radius:5px; line-height:18px;">'+ txt + '</p></div>');
		$("body").append(tipsObj);
		setTimeout(function(){
			$(".letantips").animate({opacity:0}, 500, function(){
				$(".letantips").remove();	
