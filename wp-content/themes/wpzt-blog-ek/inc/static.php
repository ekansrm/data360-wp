...
function reg_static(){
	...
	wp_register_script("bootstrap","https://lf6-cdn-tos.bytecdntp.com/cdn/expire-1-M/bootstrap/4.5.3/js/bootstrap.min.js");
...
//	wp_register_script('sweetalert','https://s3.pstatp.com/cdn/expire-1-M/sweetalert/2.1.0/sweetalert.min.js');
	...
	add_css('iconfont');
	add_css('swiper');
	wp_enqueue_style("bootstrap","https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/bootstrap/4.5.3/css/bootstrap.min.css");
